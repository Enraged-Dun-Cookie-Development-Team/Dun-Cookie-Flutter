...
class RegisterPage extends StatelessWidget {
  ...
  Future<bool> _registerMobPush(String regId) async {
    if (SettingManager.getInstance().rid.value != regId) {
      SettingManager.getInstance().updateRid(regId);
    }
    print('MobID: ' + regId);
    var success = false;
    var retry = 0;
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      text: "不同意",
                      style: const TextStyle(color: gray_1),
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          exit(0);
                        },
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        bool success = await _registerMobPush(rid);
