...
class RouteLogObserver extends NavigatorObserver {
  ...
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    DunLog.info(_genRouteInfo('push', route, previousRoute));
  }
  ...
  void didPop(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    if (route.settings.name == null) return;
    DunLog.info(_genRouteInfo('pop', route, previousRoute));
  }
  ...
  void didRemove(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    if (route.settings.name == null) return;
    DunLog.info(_genRouteInfo('remove', route, previousRoute));
  }
  ...
  void didReplace({Route<dynamic>? newRoute, Route<dynamic>? oldRoute}) {
    ...
    DunLog.info(_genRouteInfo('replace', newRoute, oldRoute));
  }
